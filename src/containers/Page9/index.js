...
import {nextQues,setBreath,hasAsthma} from './actions'
import {styles} from './styles';
import { setAge } from '../Page2/actions';
...
class Page9 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you have issues breathing?" SubHeader="Being out of breath after a strenuous workout doesn't count"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
  ...
  button = () => (
    ...
    >
      <SafeAreaView>
      <Button
        title="Sometimes, I have asthma"
        titleStyle={styles._buttonText}
        buttonStyle={styles._buttonStyle}
        onPress={()=>{this.handleSelect(1);this.props.hasAsthma()}}
      />
      </SafeAreaView>
    </Animated.View>
  )
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({nextQues,setBreath,hasAsthma},dispatch);
}
export default connect(null,mapDispatchToProps)(Page9);
