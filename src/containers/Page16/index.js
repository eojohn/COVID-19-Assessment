...
import {setHead,nextQues} from './actions';
...
class Page16 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you have a headache?" SubHeader="Does your head hurts?"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({nextQues,setHead}, dispatch);
}
export default connect(null,mapDispatchToProps)(Page16);
