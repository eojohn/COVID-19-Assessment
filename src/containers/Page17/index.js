...
import {nextQues,setFever} from './actions'
...
class Page17 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Top="Final Question" Header="Do you have a fever?" SubHeader="Is your body temperature unusually hot? Is your body temperature above 106 Degrees or 37 Celcius?"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({nextQues,setFever},dispatch)
}
export default connect(null,mapDispatchToProps)(Page17);
