...
import {setPoop,nextQues} from './actions';
...
class Page15 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you have diarrhea?" SubHeader="Watery poop"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({setPoop,nextQues},dispatch)
}
