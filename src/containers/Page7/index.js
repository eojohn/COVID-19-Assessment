...
import {setTaste,nextQues} from './actions';
...
class Page7 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you still enjoy your favorite meals?" SubHeader="Compare the experience to two months ago"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({setTaste,nextQues}, dispatch)
}
export default connect(null, mapDispatchToProps)(Page7);
