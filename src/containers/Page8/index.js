...
import {setSmoke,nextQues} from './actions';
...
class Page8 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you vape or smoke?" SubHeader="Be honest"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
...
const mapDispatchToProps = dispatch =>{
  return bindActionCreators({setSmoke,nextQues},dispatch)
}
export default connect(null,mapDispatchToProps)(Page8);
