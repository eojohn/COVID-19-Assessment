...
import {nextQues,setCough,skipCough} from './actions';
...
class Page10 extends Component {
  ...
  header = () => (
    ...
    >
      <Header Header="Do you have a cough?" SubHeader="Cough should be persistant"/>
    </Animated.View>
    </SafeAreaView>
  )
  no = () => (
  ...
  handleSelect = (index) => {
    //Set cough
    this.props.setCough(index);
    if(index === 0){
      this.props.skipCough()
    }
    //Next question
    this.props.nextQues()
  }
...
const mapDispatchToProps = dispatch=>{
  return bindActionCreators({nextQues,setCough,skipCough},dispatch)
}
export default connect(null,mapDispatchToProps)(Page10);
