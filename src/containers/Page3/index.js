...
import {setGender,nextQues} from './actions';
...
const mapDispatchToProps = dispatch => {
  return bindActionCreators({nextQues,setGender,whiteBg}, dispatch);
}
